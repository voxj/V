...
<h4><code>browser.open 'url';</code>: opens a link in the default browser. Requires browser to be <a href="https://github.com/voxj/V?tab=readme-ov-file#import-module-imports-a-module-if-using-deobfuscated-version-py-you-can-set-allmodhackon-to-true-to-make-the-imports-unnecessary-currently-importable-modules-are-vgraphics-colors--vcord-browser">imported</a>;</h4>
...
<h4><code>vcord.Bot.client {"prefix":"PrefixHere"};</code>: Defines the command prefix of the bot. Requires vcord to be <a href="https://github.com/voxj/V?tab=readme-ov-file#import-module-imports-a-module-if-using-deobfuscated-version-py-you-can-set-allmodhackon-to-true-to-make-the-imports-unnecessary-currently-importable-modules-are-vgraphics-colors--vcord-browser">imported</a>;</h4>
<h4><code>vcord.Bot.add_command {"name":"commandname","reply":"replythinghere"};</code>: Adds a command. Requires vcord to be <a href="https://github.com/voxj/V?tab=readme-ov-file#import-module-imports-a-module-if-using-deobfuscated-version-py-you-can-set-allmodhackon-to-true-to-make-the-imports-unnecessary-currently-importable-modules-are-vgraphics-colors--vcord-browser">imported</a>;</h4>
<h4><code>vcord.Bot.add_command {"event":"eventname","includables":"suchthingsasctxandetc","whatwillhappen":"whatwillhappen-inpython"};</code>: Adds an event. Requires vcord to be <a href="https://github.com/voxj/V?tab=readme-ov-file#import-module-imports-a-module-if-using-deobfuscated-version-py-you-can-set-allmodhackon-to-true-to-make-the-imports-unnecessary-currently-importable-modules-are-vgraphics-colors--vcord-browser">imported</a>;</h4>
<h4><code>vcord.Bot.AddErrorMessage "MessageHere";</code>: Adds an error message that will be replied with by the bot. Doesn't work curently. Requires vcord to be <a href="https://github.com/voxj/V?tab=readme-ov-file#import-module-imports-a-module-if-using-deobfuscated-version-py-you-can-set-allmodhackon-to-true-to-make-the-imports-unnecessary-currently-importable-modules-are-vgraphics-colors--vcord-browser">imported</a>;</h4>
<h4><code>vcord.Bot.run --token: TokenHere;</code>: Defines the token for the bot. Does NOT start the bot. Requires vcord to be <a href="https://github.com/voxj/V?tab=readme-ov-file#import-module-imports-a-module-if-using-deobfuscated-version-py-you-can-set-allmodhackon-to-true-to-make-the-imports-unnecessary-currently-importable-modules-are-vgraphics-colors--vcord-browser">imported</a>;</h4>
<h4><code>vcord.Bot.run --start;</code>: Starts the bot. Requires <code>vcord.Bot.client</code> and <code>vcord.Bot.run --token:</code> to be ran earlier. Requires vcord to be <a href="https://github.com/voxj/V?tab=readme-ov-file#import-module-imports-a-module-if-using-deobfuscated-version-py-you-can-set-allmodhackon-to-true-to-make-the-imports-unnecessary-currently-importable-modules-are-vgraphics-colors--vcord-browser">imported</a>;</h4>
<h4><code>colors;</code>: Says <code>Colors! Yay!</code>. Requires colors to be <a href="https://github.com/voxj/V?tab=readme-ov-file#import-module-imports-a-module-if-using-deobfuscated-version-py-you-can-set-allmodhackon-to-true-to-make-the-imports-unnecessary-currently-importable-modules-are-vgraphics-colors--vcord-browser">imported</a>;</h4>
<h4><code>V.Graphics.alert 'text';</code>: Makes an error/alert message. Requires V.Graphics to be <a href="https://github.com/voxj/V?tab=readme-ov-file#import-module-imports-a-module-if-using-deobfuscated-version-py-you-can-set-allmodhackon-to-true-to-make-the-imports-unnecessary-currently-importable-modules-are-vgraphics-colors--vcord-browser">imported</a>;</h4>
<h4><code>V.Graphics.error 'text';</code>: Makes an error/alert message. Requires V.Graphics to be <a href="https://github.com/voxj/V?tab=readme-ov-file#import-module-imports-a-module-if-using-deobfuscated-version-py-you-can-set-allmodhackon-to-true-to-make-the-imports-unnecessary-currently-importable-modules-are-vgraphics-colors--vcord-browser">imported</a>;</h4>
